  ...
  <section class="why_section layout_padding">
    <div class="container">
      ...
      <div class="why_container">
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              ...
              doloribus aperiam numquam! Eligendi corrupti, molestias laborum dolores quod
              nisi vitae voluptate ipsa? In tempore voluptate ducimus officia id,
        ...
        <div class="box">
          <div class="img-box">
            <img src="../../../public/images/w4.png" alt="" />
          </div>
          <div class="detail-box">
